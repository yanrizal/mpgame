...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyboard = __webpack_require__(50);
	...
	_keyboard.socket.on('server:newPos', function (data) {
		for (var i = data.length - 1; i >= 0; i--) {
			var isExist = i in players;
			if (!isExist) {
				var player = (0, _player.Player)(data, i);
				players.push(player);
	...
	_keyboard.socket.on('server:disconnect', function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keyboard = __webpack_require__(51);
	...
	var rightBtn = (0, _keyboard.keyboard)(68);
	var leftBtn = (0, _keyboard.keyboard)(65);
	var upBtn = (0, _keyboard.keyboard)(87);
	var downBtn = (0, _keyboard.keyboard)(83);
...
/***/ function(module, exports) {
	...
	var keyboard = exports.keyboard = function keyboard(keyCode) {
	  var key = {};
	  key.code = keyCode;
	  key.isDown = false;
	  key.isUp = true;
...
/***/ function(module, exports) {
	...
	var Player = exports.Player = function Player(data, i) {
	  var self = PIXI.Sprite.fromImage('/img/oldman.gif');
	  self.x = data[i].x;
	  self.y = data[i].y;
	  return self;
	};
	
	var Bullet = exports.Bullet = function Bullet(data, i) {
	  var self = PIXI.Sprite.fromImage('/img/bullet.png');
	  self.x = data[i].x;
	  self.y = data[i].y;
	  return self;
	};
